...
class SSms {
    ...
    public function sendSMS($mobiles, $message)
    {
    	...
    	$url = "http://www.strust.com/httpSmsProvider.aspx";
    	$stringToPost = "username=".SMS_USERNAME."&password=".SMS_PASSWORD."&mobile=".$mobiles."&unicode=U"."&message=".$msg."&sender=".SMS_SENDER;
